...
cap = cv2.VideoCapture(0, cvv2.CAP_DSHOW)
...
def Detecta_Movimientos(face_landmarks): #definimos esta funcion para detectar movimientos
    ...
    cvv2.line(frame, (x_Punto_Ojo_Izq, y_Punto_Ojo_Izq), (x_Punto_Ojo_Der, y_Punto_Ojo_Der), color_distancia, 1)
    ...
    cvv2.circle(frame, (x_Izquierdo_Labio, y_Izquierdo_Labio), 3, color_horizontal, 1)# primer numero diametro exterior y segundo el interior
    cvv2.circle(frame, (x_Derecho_Labio, y_Derecho_Labio), 3, color_horizontal, 1)

    cvv2.circle(frame, (x_Superior_Labio, y_Superior_Labio), 3, color_vertical, 1)
    cvv2.circle(frame, (x_Inferior_Labio, y_Inferior_Labio), 3, color_vertical, 1)
    
    cvv2.line(frame, (x_Izquierdo_Labio, y_Izquierdo_Labio), (x_Derecho_Labio, y_Derecho_Labio), color_horizontal, 1) # grosor de linea
    cvv2.line(frame, (x_Superior_Labio, y_Superior_Labio), (x_Inferior_Labio, y_Inferior_Labio), color_vertical, 1)
...
def Detecta_Ojos(face_landmarks): #definimos esta funcion para detectar movimientos
    ...
    cvv2.circle(frame, (x_Izquierdo_Ojo_Izq, y_Izquierdo_Ojo_Izq), 5, color_horizontal, 2)
    cvv2.circle(frame, (x_Derecho_Ojo_Izq, y_Derecho_Ojo_Izq), 5, color_horizontal, 2)

    cvv2.circle(frame, (x_Superior_Ojo_Izq, y_Superior_Ojo_Izq), 5, color_vertical, 2)
    cvv2.circle(frame, (x_Inferior_Ojo_Izq, y_Inferior_Ojo_Izq), 5, color_vertical, 2)
    
    cvv2.line(frame, (x_Izquierdo_Ojo_Izq, y_Izquierdo_Ojo_Izq), (x_Derecho_Ojo_Izq, y_Derecho_Ojo_Izq), color_horizontal, 3)
    cvv2.line(frame, (x_Superior_Ojo_Izq, y_Superior_Ojo_Izq), (x_Inferior_Ojo_Izq, y_Inferior_Ojo_Izq), color_vertical, 3)
...
with mp_face_mesh.FaceMesh(
    ...
    while True:
        ...
        frame = cvv2.flip(frame,1) #detectamos la cara
        frame_rgb = cvv2.cvtColor(frame, cvv2.COLOR_BGR2RGB) # la convertimos a RGB
        results = face_mesh.process(frame_rgb)

        if results.multi_face_landmarks is not None:
            for face_landmarks in results.multi_face_landmarks:
                
                cvv2.rectangle(frame, (Cuadro_InteraccionX, Cuadro_InteraccionY), (anchocam - Cuadro_InteraccionX, altocam - Cuadro_InteraccionY), (100, 0, 0), 2)  # Generamos cuadro
                    
                x = int(face_landmarks.landmark[19].x * width)
                y = int(face_landmarks.landmark[19].y * height)

                cvv2.circle(frame, (x, y), 6, Color_Puntero, 1)
                cvv2.circle(frame, (x, y), 2, Color_Puntero, -1)
                ...
                #cvv2.circle(frame, (x,y), 10, (0,0,0), cvv2.FILLED)
                ...
                #cvv2.circle(frame, (x, y), 2, (255, 0, 255), 2)
                '''
